        ...
        <div className="h-screen landing-bg">
            ...
            <div className="flex items-center justify-start h-full pl-40">
                <div className="flex flex-col gap-8">
                    ...
                    <button onClick={() => navigate('/feasibility')} className="bg-primary-pink text-white font-[Istok Web] font-medium text-[20px] rounded-lg hover:bg-primary-pink/90 hover:translate-y-[-2px] hover:shadow-lg transition-all duration-300 px-5 py-3 w-fit flex items-center gap-2 mt-16">
